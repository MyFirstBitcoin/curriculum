...
> Bitcoin için Visa ağı inşa ediyoruz. Ama bence asıl güçlü olan şey, Visa'nın aksine, herkesin bunun üzerine inşa edebilmesi.  
_Elif Yıldız_

Teknolojiler genellikle katmanlar halinde, bir yığın gibi büyür ve genişler. Favori web sitenizi, e-postanızı veya sosyal medyanızı düşünün: Bunlar, internet protokolünün üzerine inşa edildi; internet protokolü bilgisayarların üzerine, bilgisayarlar ise elektriğin üzerine inşa edildi ve bu böyle devam eder. Bu teknolojiler çok basit bir tasarımla başladı ve zamanla gelişmeye devam etti.

Bitcoin de bir istisna değildir. Andreas Antonopoulos'un ünlü sözüyle, “Bitcoin paranın internetidir.” O, sağlam dijital paranın temel katmanıdır ve üzerine yeni teknolojilerin inşa edileceği sağlam bir temel sunar.
