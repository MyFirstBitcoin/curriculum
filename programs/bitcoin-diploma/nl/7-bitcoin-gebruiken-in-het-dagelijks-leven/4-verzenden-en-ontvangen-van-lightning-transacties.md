...
Met een Lightning-wallet is het gebruik van Bitcoin snel, goedkoop en privé, waardoor transacties tussen twee personen eenvoudig zijn. Je kunt snel bitcoin versturen en ontvangen voor alledaagse dingen zoals het kopen van koffie.

Laten we een paar voorbeelden bekijken van het Lightning Network in de praktijk.

###### Voorbeeld 1

Zowel Marcia als Eva hebben 5 eenheden van de valuta. Marcia wil 2 eenheden naar Eva sturen. De betaling gaat via Jef, die helpt om de betaling door het Lightning Network te sturen. Nadat de betaling is voltooid, heeft Eva 7 eenheden en Marcia 3.

Jef helpt de betaling te routeren, maar hij kan het geld niet stelen. Het Lightning Network gebruikt cryptografie om ervoor te zorgen dat alleen de bedoelde ontvanger de betaling kan ontvangen. Jef helpt simpelweg om de betaling door het netwerk te laten gaan.
...
Node-operators zoals Jef kunnen ook kleine vergoedingen verdienen voor het helpen bij het routeren van betalingen. Door dit te doen, helpen ze het netwerk gedecentraliseerd en efficiënt te houden.
...
Het Lightning Network maakt het mogelijk om direct en met zeer lage kosten bitcoin te versturen. Dit maakt het ideaal voor kleine, dagelijkse aankopen zoals koffie.
...
On-chain transacties vinden direct plaats op de Bitcoin-blockchain en kunnen meer tijd en kosten met zich meebrengen. Lightning-transacties gebeuren off-chain, waardoor snelle en goedkope betalingen mogelijk zijn, terwijl je toch bitcoin gebruikt.
...
Dit is een kaart van het volledige Lightning Network. Dankzij duizenden Lightning-nodebeheerders kun je sats sturen naar elke gebruiker met een Bitcoin Lightning-wallet, waar ter wereld ze zich ook bevinden. De betaling komt binnen enkele seconden aan en kost slechts een paar cent.**Probeer het zelf uit!**
...
1. Let goed op de eenheden. Sommige wallets laten gebruikers bitcoin OF sats versturen (1/100.000.000 van een bitcoin).
