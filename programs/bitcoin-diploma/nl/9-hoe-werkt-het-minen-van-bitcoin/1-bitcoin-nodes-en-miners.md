...
Bitcoin-nodes klinken misschien technisch, maar het zijn simpelweg programma’s die een kopie van de Bitcoin-blockchain op een computer bewaren. De blockchain is een gedeeld overzicht van alle Bitcoin-transacties.
...
Ten eerste bewaart het een kopie van de blockchain, wat de geschiedenis is van alle Bitcoin-transacties.

Ten tweede maken nodes verbinding met andere nodes over de hele wereld en delen ze informatie. Een voorbeeld hiervan is de lijst met nieuwe transacties die wachten op bevestiging, ook wel de mempool genoemd.

Ten derde controleren nodes of elke transactie voldoet aan de regels van Bitcoin. Als een transactie ongeldig is, wijst de node deze af.

Nodes helpen ook nieuwe nodes om zich bij het netwerk aan te sluiten door de blockchain met hen te delen. Elke nieuwe node controleert echter alsnog zelfstandig alle regels.
...
Ongeveer elke 210.000 blokken (ongeveer elke 4 jaar) wordt de blokbeloning gehalveerd. Dit evenement heet de **halvering**. De halvering vertraagt de creatie van nieuwe bitcoin en helpt ervoor te zorgen dat de totale voorraad nooit meer dan 21 miljoen zal zijn. Na verloop van tijd maakt dit bitcoin steeds schaarser.


> **Definition – Circulerende voorraad**
>
> **Circulerende voorraad** verwijst naar de totale beschikbare hoeveelheid van een valuta. Bij Bitcoin is de totale circulerende voorraad het aantal munten dat is gemined en op elk moment in omloop is.



> **Definition – Bitcoin-voorraadschema**
>
> Het **Bitcoin-voorraadschema** is het vooraf bepaalde en openbare plan voor de uitgifte van nieuwe bitcoin in omloop, ontworpen om de schaarste van Bitcoin in de loop van de tijd te behouden.
...
De onderstaande tabel toont de aankomende halvings, inclusief de geschatte datum, het bloknummer waarop ze plaatsvinden, de nieuwe blokbeloning en het percentage van de totale bitcoinvoorraad dat dan gemijnd zal zijn.
...
Een hash werkt als een **digitale vingerafdruk** voor de gegevens in het blok. Als er iets in het blok zou worden gewijzigd, zou de vingerafdruk ook veranderen. Dit maakt het eenvoudig voor iedereen om te controleren dat de transactiegeschiedenis van de blockchain niet is aangepast en helpt het netwerk veilig te houden.
...
> **Info**
>
> Door een geldige blokhash te vinden, bewijst een miner dat hij het vereiste werk heeft verricht om een nieuw blok aan de blockchain toe te voegen. Dit proces heet Proof of Work (PoW). Het is het beveiligingsmechanisme waarmee Bitcoin transacties bevestigt en nieuwe blokken aan de blockchain toevoegt. De miner die als eerste de geldige hash vindt, verdient een beloning in bitcoin, bestaande uit de blokbeloning en de transactiekosten van de transacties in dat blok.


Proof of Work (PoW) helpt Bitcoin veilig te houden door het extreem duur te maken voor iemand om te proberen vals te spelen of het netwerk over te nemen. Het is veel winstgevender om de regels te volgen.
...
1. **Verdien beloningen**: Als het blok geldig is, wordt het toegevoegd aan de blockchain en ontvangt de miner nieuw aangemaakte bitcoin plus transactiekosten.
...
* Miners herhalen dit proces vele malen, op zoek naar een hash die voldoet aan de regels van Bitcoin. De eerste miner die een geldige hash vindt, krijgt nieuw aangemaakte bitcoin als beloning en hun blok wordt toegevoegd aan de blockchain.
