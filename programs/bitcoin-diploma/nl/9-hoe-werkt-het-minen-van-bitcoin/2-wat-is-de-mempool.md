...
**Deze activiteit laat studenten kennismaken met een gratis en open-source tool die geen technische vaardigheden vereist. Het is nuttig voor Bitcoiners van elk niveau, van beginner tot gevorderde.**

###### Belangrijke Punten

1. **Mempool** verwijst naar de lijst van onbevestigde transacties die door elke Bitcoin-node wordt bijgehouden, niet naar een specifieke dienst of platform.
1. Er is niet één enkele, universele mempool. Mempool.space is er één van velen.
1. [Mempool.space](https://mempool.space) is open-source en staat bekend als een gebruiksvriendelijke visuele block explorer. Het biedt realtime gegevens over onbevestigde transacties, transactiekosten en andere netwerkactiviteit.

###### Studententip

Mempool.space doet veel meer dan alleen blokken visualiseren. Ontdek andere delen van het Bitcoin-ecosysteem: bijvoorbeeld Lightning, mining, de hash rate, pools en block space "goggles".
