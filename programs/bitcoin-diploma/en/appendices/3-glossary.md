...
**Cold Storage:** A method of storing bitcoin oﬄine, away from the risk of hackers or other online threats.
...
**Double Coincidence of Wants:** Inherent problem in the barter economy, which requires each party in an exchange to want what the other has to oﬀer, in that specific amount.
...
**Lightning Network:** A layer-2 payment protocol for smaller transactions that enables faster and cheaper Bitcoin transactions by using oﬀ-chain channels.

**Medium of Exchange:** Objects widely accepted in exchange for goods and services.

**Merkle Tree:** A tree-like data structure used in the Bitcoin blockchain to eﬃciently verify the integrity of large sets of data.
...
**Nonce:** A random number added to a block header to create a hash that meets the diﬃculty target.
...
**Paper Wallet:** A printed copy of a user's private and public keys used for storing and managing Bitcoin oﬄine.
