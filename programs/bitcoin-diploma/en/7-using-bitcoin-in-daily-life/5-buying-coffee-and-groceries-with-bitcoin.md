...
| Customers Pays | Issuing Bank | Card Network Processors | Payment Processors | Goes to merchant |
| --- | --- | --- | --- | --- |
...
To find a merchant that accepts bitcoin in your area, go to [BTCMap.org](https://btcmap.org) and search for your region. BTCMap.org is an open-source map where merchants that accept Bitcoin can list their businesses. Plus, users can also add new merchants and even update the map to make sure the listed merchants are still accepting bitcoin. It’s a powerful tool for people who wish to spend their bitcoin.
