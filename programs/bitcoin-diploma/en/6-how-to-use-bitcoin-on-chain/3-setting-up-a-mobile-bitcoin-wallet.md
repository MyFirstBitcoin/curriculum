# 6.3 Setting Up a Mobile Bitcoin Wallet
...
If students do not have smartphones, the teacher will provide one for students to borrow. There are two options for this activity.
...
>
> NOTE: Do not send ANY bitcoin to the address of these seed phrase. This is just an example



> **Note – Class Exercise: Option 2 — Restore a wallet (Time-Limited)**
>
