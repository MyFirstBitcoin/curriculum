...
Over time, people have realized that money must possess certain qualities to be effective as a medium of exchange, store of value and unit of account. These characteristics include durability, divisibility, portability, acceptability, scarcity, and fungibility.
...
Overall, these characteristics make money a useful and eﬀective tool for facilitating trade and commerce, and are thus essential for economic development and stability.

#### Class Exercise

Diﬀerent assets have diﬀerent properties and perform the functions of money to varying degrees. Society ultimately determines which asset is used as money based on how well a particular good performs these functions.

To determine how well diﬀerent items meet the specific characteristics of money, you can score each item below on a scale from 1 to 5 for each characteristic. By tallying up the scores for each item, you can determine which one is best suited to be a form of money.
...
* **Portability:** Can the money be easily transported and used in diﬀerent locations?
...
* **Scarcity:** Is the money scarce and diﬃcult to make more of?
