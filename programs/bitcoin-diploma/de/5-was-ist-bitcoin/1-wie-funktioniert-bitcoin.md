...
1. **Konsens = Einigkeit**
1. Ein großer Unterschied zwischen einer Gruppe mit zentraler Kontrolle und einer ohne ist die Frage des Vertrauens. Dezentralisierte Gruppen wie Peer-to-Peer-Netzwerke haben keinen Anführer und die Teilnehmer vertrauen einander nicht. Sie benötigen eine andere Art der Koordination.
...
1. Dass Bitcoin dezentral ist, ist entscheidend für seinen Wert. Historisch gesehen sind menschliche Anführer immer der Versuchung erlegen, Geld auf lange Sicht zu entwerten.
1. Der Nakamoto-Konsens ist nach dem Schöpfer von Bitcoin, Satoshi Nakamoto, benannt. Dieser Konsensmechanismus ist der Grund, warum Tausende von Fremden, die sich nicht vertrauen, das Bitcoin-Ledger seit 2009 aufrechterhalten.
