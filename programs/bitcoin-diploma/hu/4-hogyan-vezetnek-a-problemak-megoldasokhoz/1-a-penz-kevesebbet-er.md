...
1. Ne feledd: Infláció = pénzkínálat növekedése. Ez a lényege a „több pénz üldözi ugyanazokat a javakat” kifejezésnek.
1. Óvakodj az „infláció” szó helytelen használatától! A monetáris infláció nem ugyanaz, mint az ár-infláció. A hírmédia és a központi tervezők inkább az ár-inflációs mutatókat, például a fogyasztói árindexet (CPI) használják, mert ezeket lehet manipulálni.
1. Amikor fiat pénzt hoznak létre, azt nem osztják el egyenlően. Először azokhoz kerül, akik közel vannak a pénznyomtatóhoz (például nagy ipari szereplők). Ők igazságtalanul vásárolhatnak eszközöket, mielőtt az árak mindenki más számára emelkednének.
