...
1. Prices in a free market are set by individuals' subjective values (e.g., students bidding for items).
1. Remember that Inflation = increase in money supply. This is the concept behind the phrase "more money chasing the same goods".
1. Beware of misuse of the word "inflation". Monetary inflation is not the same as price inflation. News media and central planners prefer to use price inflation measures like consumer price inflation (CPI) because it can be manipulated.
1. When fiat money is created, it is not distributed evenly. It flows first to those closest to the money printer (e.g., big industry players). They can unfairly purchase assets before prices rise for everyone else.
