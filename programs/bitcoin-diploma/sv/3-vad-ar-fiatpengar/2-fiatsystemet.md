...
> **Definition – Definition av lag om lagligt betalningsmedel**
>
...
1. **Banker lånar pengar från insättare till en viss ränta** (låt oss säga 5 %)
1. **Banker lånar ut dessa pengar till låntagare till en högre ränta** (låt oss säga 9 %)
...
1. En bråkdel = en del av en helhet.
1. Fraktionell reservbankverksamhet är ett verktyg som banker använder för att låna ut mer än de har i kassan, eller ”i reserv”.
1. Ju mindre reservbeloppet är, desto större risk löper bankerna för bankrusningar eller betalningsinställelse.
1. Detta verktyg kan användas med sund valuta (som guld) eller med osund valuta (som fiat).
1. Möjligheten att utöka penningmängden, i kombination med nödlån och försäkringsprogram som insättningsgarantin (FDIC), leder till moraliska risker för banker. De har incitament att ta större risker eftersom de behåller vinsterna, men förlusterna betalas av alla.
