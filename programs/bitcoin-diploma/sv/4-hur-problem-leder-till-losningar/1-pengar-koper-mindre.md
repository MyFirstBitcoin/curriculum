...
1. Priser på en fri marknad sätts av individers subjektiva värderingar (t.ex. elever som bjuder på föremål).
1. Kom ihåg att Inflation = ökning av penningmängden. Detta är tanken bakom uttrycket "mer pengar jagar samma varor".
1. Var uppmärksam på felanvändning av ordet "inflation". Monetär inflation är inte samma sak som prisinflation. Nyhetsmedia och centralplanerare föredrar att använda prisinflationsmått som konsumentprisindex (KPI) eftersom det kan manipuleras.
1. När fiatpengar skapas fördelas de inte jämnt. De går först till dem som står närmast penningtryckeriet (t.ex. stora aktörer inom industrin). De kan orättvist köpa tillgångar innan priserna stiger för alla andra.
