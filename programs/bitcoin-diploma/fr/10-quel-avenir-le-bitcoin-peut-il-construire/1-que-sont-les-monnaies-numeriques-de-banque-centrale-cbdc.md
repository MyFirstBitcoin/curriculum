# 10.1 Que sont les monnaies numériques de banque centrale (CBDC) ?
...
> **Callout**
>
> You can check if your country is trying CBDCs on the Human Rights Foundation’s CBDC tracker at [cbdctracker.hrf.org](https://cbdctracker.hrf.org/) or [cbdctracker.org](https://cbdctracker.org/)


So, besides being digital, what makes CBDCs diﬀerent from regular fiat money? It's crucial to understand that, unlike regular fiat money in the form of paper or coins, CBDCs let the government digitally watch and control every transaction globally. This means the government can stop certain transactions or even freeze your whole account if they don't like you or how you're using your money.
