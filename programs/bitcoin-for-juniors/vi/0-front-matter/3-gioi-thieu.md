...
Hướng dẫn này giải thích cách đọc và sử dụng các kế hoạch bài học trong Bitcoin for Juniors. Nó đi qua từng phần của định dạng kế hoạch bài học để giáo viên biết điều gì sẽ xảy ra, cách chuẩn bị và cách điều chỉnh nội dung phù hợp với bối cảnh của mình. Cấu trúc này được tạo ra để phục vụ bạn — không phải ngược lại.
...
Mỗi hoạt động đều tuân theo một định dạng nhất quán. Điều này giúp giáo viên nhanh chóng xác định những gì cần thiết và cách tổ chức buổi học hiệu quả.

##### Loại Hoạt động

Các hoạt động được phân loại để dễ dàng lên kế hoạch. Ví dụ: trò chơi mô phỏng, thảo luận có hướng dẫn, học tập trải nghiệm, thử thách hợp tác. Những nhãn này giúp giáo viên chọn hoạt động phù hợp với mục tiêu giảng dạy và mức năng lượng của lớp học.

##### Thời lượng

Thời gian được liệt kê chỉ là ước lượng. Một số nhóm sẽ làm nhanh. Nhóm khác sẽ cần thảo luận nhiều hơn. Giáo viên nên xem thời lượng như một hướng dẫn linh hoạt thay vì giới hạn nghiêm ngặt.
...
Kết quả học tập xác định những gì học sinh nên biết, hiểu hoặc có thể làm được sau khi kết thúc hoạt động. Đây là những kết quả quan trọng. Chúng giúp giáo viên tập trung vào mục đích thay vì chỉ hoàn thành nhiệm vụ. Nếu thời gian hạn chế, hãy ưu tiên kết quả học tập hơn là hoàn thành mọi bước.
...
1. **Chuẩn bị** — Hướng dẫn tổ chức học sinh và phát vật liệu.
...
Ghi chú cho giáo viên. Phần này bao gồm nhắc nhở thu gom vật liệu, cất giữ tài nguyên, sắp xếp lại lớp học và chuẩn bị cho buổi học tiếp theo.

#### Quản lý Lớp học

Mỗi lớp học đều khác nhau về độ tuổi, mức năng lượng và động lực nhóm. Các gợi ý trong phần này có thể bao gồm:

* Hướng dẫn rõ ràng trước khi di chuyển
* Giới hạn thời gian được xác định
* Quy tắc rõ ràng
* Vai trò được phân chia rõ ràng trong nhóm
...
Phân hóa đảm bảo mọi học sinh đều có thể tiếp cận bài học. Các điều chỉnh có thể bao gồm:

* Ngôn ngữ đơn giản cho học sinh nhỏ tuổi
* Hỗ trợ hình ảnh cho học sinh mới biết đọc
...
Phụ lục bao gồm tài liệu hỗ trợ, mẫu, tài nguyên in được và các liên kết được nhắc đến trong bài học. Giáo viên nên xem trước phụ lục trước khi lên lớp để đảm bảo đã chuẩn bị đầy đủ tài liệu cần thiết.
