...
1. When you find a match, say clearly: “It’s mine.”
1. Demonstrate flipping two cards and replacing them if they do not match.
...
1. Give each team one WALLET envelope.
1. Place all word cards face down in the MEMPOOL area.
1. Place the BLOCK envelope at the front.

**Carry Out**

1. Use 20 cards in the mining pool.
1. Teams take turns flipping two cards.
1. If they match, they say “It’s mine.”
1. They collect one word from the mempool.
1. They must read it correctly to keep it temporarily.
1. After 6–8 minutes, stop the round.
1. If too many words were mined, increase difficulty by adding more cards.If too few were mined, decrease difficulty by removing cards.
1. State simply:“When mining is too fast, we make it harder.When mining is too slow, we make it easier.”

**Carry Out**

1. At the end of each round, collect all earned words into the BLOCK envelope.
1. Announce “Block complete.”
