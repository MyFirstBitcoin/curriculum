...
1. Clear the wall of any objects and clean the wall to ensure sticky notes can adhere to the wall.
1. Place any objects from your home on the table at the front of the class before students enter.
...
1. Discuss their price and value.
1. Introduce the two ideas:
  1. **Price**: how much something costs
  1. **Value**: how useful or important something is
1. Ask students to give their opinion on the object and if they agree or disagree.
...
1.  Each student writes one item per sticky note.
  1. Prompt questions:
      1. “Which things are important to you?”
    1. “Which things don’t really matter?”
1. If possible, each student can have their own respective color of sticky note to easily distinguish items later in the activity.
1. Tape a long horizontal line across the board (_See Appendix B_).Label this axis:
  1. Left = “Low Price”
  1. Right = “High Price”
1. Then add a vertical line crossing the center. Label this axis:
  1. Bottom: “Low value”
  1. Top: “High value”
...
1. Demonstrate where to place it within the four quadrants.

**Carry out**

1. Students place their sticky notes along the axis where they think their item belongs.
1. Support students by encouraging them to add as many items as possible. If students have added all of their sticky notes, prompt them for new items.
...
1. Take a moment for gratitude for the people, times and objects in their life.
