...
1. Students will **bid** using shells — whoever bids the most wins the item.

**Model**

1. **Pick one student** as the “bidder.” Hold up an item, name it clearly, and start the opening bid at 1 shell.
1. **Model bidding**: ask the student to raise their hand, say their bid out loud, and place the shells where everyone can see them. Repeat once by “outbidding” them yourself (or with a second student) to show how bids increase.
1. **Close the sale**: do a clear countdown (“Going once, going twice, sold”), ring/clap, announce the final price, hand over the item, and record the price visibly.

**Live Auction**

1. The teacher holds up an item.
1. Start at 1 shell, let students bid higher.
1. Record the final price on a sticky note and stick it to the item (visible to all).
1. Repeat for each of the 10 items.
...
1. Ask:
  ...
  1. Were some things not worth much? Why?
  1. Did everyone want the same things?
  1. Did anyone run out of shells too quickly?
...
* Some students may find this concept unfair. They may have been outbid on items they wanted. Be aware that this could be a negative learning experience. Offer the possibility of further trade and barter (see _Differentiation_ below)
...
* If no actual giveaway: instead of giving the items away, students write on post-its what they think each item _should_ cost. Compare their “predictions” with the actual auction results.
