...
1. Ask where they have seen codes before such as games, secret messages, or locks.
1. Introduce the words encode and decode using simple language.
1. Explain that today they will learn how to hide and reveal words using a code.
...
1. Draw the alphabet on the board and show a simple letter shift such as A becomes D.

**Model**

1. Demonstrate encoding a short word using a letter shift.
1. Demonstrate decoding the same word back to the original.
1. Introduce the cipher wheel and show how turning it changes the output letters.
1. Explain that the number of steps the wheel is turned changes the result.
...
1. Students place the smaller circle on top of the larger one.
...
1. Students encode given Bitcoin vocabulary words using a chosen letter shift.
1. Circulates to support students and check understanding.
