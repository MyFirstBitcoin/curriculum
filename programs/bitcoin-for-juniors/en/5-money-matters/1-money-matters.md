...
1. Writes their name clearly
1. Draws one card from the deck
1. Looks up their challenge
1. Attaches the card to the HOME tile using sticky tack
1. Checks their objective (SAVE, INVEST, or BORROW)
1. Writes the target amount on the HOME tile
...
1. HOME tiles are placed around the room or table layout.
1. Town Square acts as the central hub.
1. Learners begin at their own HOME tile.
...
1. Rolling to move
1. Completing one earning or trading action
1. Returning Home to record progress
