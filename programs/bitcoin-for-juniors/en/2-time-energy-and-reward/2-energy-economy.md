...
1. Vertical axis: Energy Level (Low → High)
1. Lay out flashcards so they are visible and easy to access.
...
1. Ask the class:
1. Make it personal:
1. Use quick show-of-hands questions:
...
1. If possible, use visual aids to illustrate time and energy tracking (_See Appendix A_)
1. Return to the Energy Tracker graph previously drawn.
1. Explain that the horizontal line shows the day from sunrise to sunset.
1. Explain that the vertical line shows energy from low at the bottom to high at the top.
1. Ask students to name examples of activities they do in the morning, afternoon, and evening.
...
1. Ask: "When do you usually do this?" and "Does this give energy or take energy?"
1. Use class consensus to place the card left to right based on time of day and up or down based on energy level.
1. Repeat with 8–10 activity cards.
1. Encourage discussion and disagreement by reminding students that activities can feel different for different people.
...
1. **Distribute** Energy Tracker handouts. (_See Appendix B_)
1. **Instruct** students to think about a typical day, choose 4–6 activities they usually do, and plot them on their own graph using words or drawings.
1. Support non-writers by providing printed images to glue or tape, allowing drawing instead of writing, and pairing with a buddy if needed.
