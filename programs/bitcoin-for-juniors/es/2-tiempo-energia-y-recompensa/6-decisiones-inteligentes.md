...
1. Repasa la lección anterior usando _Los tres cerditos_.
1. Pregunta: “¿Qué casa duró más?” y “¿Por qué era la más fuerte?”
1. Dibuja una línea horizontal en la pizarra para representar la preferencia temporal.
1. Etiqueta el lado izquierdo: Alta preferencia temporal - quiere resultados ahora.
1. Etiqueta el lado derecho: Baja preferencia temporal - está dispuesto a esperar para obtener mejores resultados. Coloca la paja, los palitos y los ladrillos a lo largo del eje.
...
1. Explica que las decisiones cotidianas son como materiales de construcción.
1. Explica que algunas decisiones son rápidas y divertidas pero débiles, mientras que otras requieren esfuerzo pero duran más.

**Modela**

1. Da un ejemplo, como dulces frente a una comida saludable.
1. Coloca cada ejemplo en el eje de preferencia temporal y explica por qué.
...
1. Introduce categorías: comida, salud, trabajo, juego, educación.
1. Da ejemplos para cada categoría, como dulces frente a verduras o hacer la tarea de prisa frente a hacerla bien.
...
1. Reparte las plantillas de superhéroes.
...
1. Forma parejas de estudiantes o grupos pequeños.
1. Haz que los estudiantes comparen las estadísticas de sus héroes en rondas al estilo Top Trumps.
1. Enfatiza que el objetivo es aprender, no ganar.

**Punto de control**

1. Observa si los estudiantes pueden explicar por qué ciertas decisiones crean héroes más fuertes.
1. Escucha si establecen conexiones entre el esfuerzo y los resultados a largo plazo.

**Reflexión**

* Pregunta: “¿Qué decisiones hicieron más fuerte a tu héroe?”
...
1. Repasa la idea de que las pequeñas decisiones diarias se acumulan con el tiempo.
...
* Mantén un tono alentador y sin juzgar
* Enfatiza que los hábitos se exploran, no se califican

##### **Actividades de extensión y de transición**

* Rediseñar al héroe después de una semana de mejores decisiones
* Desafío de gratificación diferida usando un pequeño dulce y una recompensa adicional por esperar
