...
Tato příručka vysvětluje, jak číst a používat plány lekcí v Bitcoin for Juniors. Prochází každou část formátu plánu lekce, aby učitelé věděli, co mohou očekávat, jak se připravit a jak přizpůsobit obsah svému kontextu. Struktura je zde proto, aby sloužila vám — ne naopak.
...
Každá aktivita má konzistentní formát. To umožňuje učitelům rychle zjistit, co je potřeba a jak efektivně vést lekci.
...
Uvedený čas je orientační. Některé skupiny postupují rychleji. Jiné budou potřebovat více diskuse. Učitelé by měli délku trvání vnímat jako flexibilní vodítko, nikoli jako přísný limit.
...
Seskupení pomáhá nastavit zamýšlenou dynamiku učení. Práce ve skupinách obvykle zvyšuje zapojení a pomáhá žákům upevnit si myšlenky prostřednictvím diskuse.
...
Dokončeno před příchodem žáků do třídy. Zahrnuje přípravu materiálů, uspořádání sezení, napsání zadání na tabuli a organizaci zdrojů. Příprava je nejlepší provádět bez přítomnosti žáků, aby byl zajištěn plynulý průběh.

##### PŘEDAKTIVITA

Zahřívací fáze. Nastavuje očekávání a probouzí zvědavost. Může zahrnovat otázku, krátký příběh, scénář nebo výzvu. Cílem je aktivovat předchozí znalosti a připravit žáky na úkol.

##### Cíl slovy žáka

Učitel stručně vysvětlí účel aktivity jazykem, kterému žáci rozumí. Když žáci vědí, proč něco dělají, zvyšuje se jejich zapojení a zapamatování.
...
Krátké shrnutí na závěr. Zdůrazněte klíčovou myšlenku. Ukončete pozitivně. Může zahrnovat rekapitulační otázku, rychlé sdílení ve dvojici nebo krátké propojení aktivity s širším tématem kapitoly.

##### ZÁVĚR

Poznámky pro učitele. Tato sekce obsahuje připomínky ke sběru materiálů, uložení zdrojů, úklidu třídy a přípravě na další lekci.
...
Pokud zbývá čas, rozšiřující nápady — někdy nazývané náhradní aktivity — umožňují pokračovat v aktivitě s minimální přípravou. Mohou prohloubit diskusi, přidat složitost nebo zavést kreativní prvek. Jsou volitelné a flexibilní.

#### Diferenciace

Diferenciace zajišťuje přístupnost pro různé žáky. Úpravy mohou zahrnovat:

* Zjednodušený jazyk pro mladší žáky
* Vizuální pomůcky pro začínající čtenáře
* Jasné postupné instrukce
* Upravené tempo
...
Dodatek obsahuje podpůrné materiály, šablony, tisknutelné zdroje a odkazy uvedené v lekci. Učitelé by si měli dodatek před hodinou projít, aby měli připraveny všechny potřebné materiály.
