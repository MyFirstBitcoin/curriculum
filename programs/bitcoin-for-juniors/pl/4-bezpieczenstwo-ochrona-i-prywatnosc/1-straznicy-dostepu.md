...
1. Accept multiple answers and do not correct yet.
1. Explain that today they will look at everyday examples and decide together.
...
1. Introduce the idea that there is not always one correct answer.

**Model**

1. Show one example such as a park.
1. Think aloud: “Many people can go there and see it, so we usually say this is public.”
1. Show a second example such as a password.
1. Think aloud: “This belongs only to one person, so we usually keep it private.”

**Carry Out**

1. Show one visual example at a time.
1. Ask students to vote or raise their hands for ‘public’ or ‘private’.
1. Place the example under the matching heading on the board.
1. Ask follow-up questions such as “Why?” or “Could this ever change?”
1. Use examples such as park, bus, washroom, car, eye colour, password, bank PIN.

**Checkpoint**

1. Ask students to explain the difference between public and private in their own words.
1. Listen for understanding rather than memorized definitions.
