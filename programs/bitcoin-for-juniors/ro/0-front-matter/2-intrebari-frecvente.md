...
#### 2. Cui se adresează Bitcoin for Juniors?
...
Copiii nu trebuie să folosească portofele Bitcoin sau să gestioneze chei private. Au nevoie de bazele necesare pentru a înțelege Bitcoin mai târziu.

B4J este intenționat low-tech — lecțiile folosesc materiale fizice, nu dispozitive — ceea ce îl face accesibil în orice mediu de clasă și potrivit pentru cei mai mici. Scopul este pregătirea conceptuală, nu stăpânirea tehnică.

#### 4. Ce învață copiii în acest program?

Bitcoin for Juniors predă conceptele cheie necesare pentru a înțelege Bitcoin, inclusiv:

* Ce este banii și de ce îi folosesc societățile
* Diferența dintre valoare și preț
* Timp, energie, efort și recompensă
* Raritate și abundență
* Informații publice versus private
* Idei de bază despre criptare și coduri
* Evoluția istorică a banilor
* Originea și scopul Bitcoin

Aceste idei sunt explorate prin jocuri, povești, mișcare și activități colaborative. Copiilor nu li se spune ce să creadă despre Bitcoin — li se oferă instrumente pentru a gândi despre bani, valoare și corectitudine și pentru a ajunge la propriile concluzii.

#### 5. Este acesta un curs despre investiții, tranzacționare sau folosirea banilor reali?
...
Programul este conceput să fie low-tech și foarte interactiv. Lecțiile pot fi predate folosind:

* Fișe de lucru tipărite
* Simulări de rol
* Jetoane fizice, cartonașe sau materiale simple de clasă
* Discuții ghidate în grup

Ghidul pentru profesori oferă instrucțiuni pas cu pas, sfaturi pentru gestionarea clasei, întrebări pentru reflecție și idei de extindere. Nu este necesară cunoașterea avansată a Bitcoin.
