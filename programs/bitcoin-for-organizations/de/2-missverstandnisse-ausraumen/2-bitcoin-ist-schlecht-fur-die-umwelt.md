...
1. Das Fiat-Währungssystem umfasst die gesamte Bankeninfrastruktur, Filialen, Rechenzentren und Büros.
1. Wie verhält sich das im Vergleich zu anderen Energieverbräuchen?
1. Welchen Wert liefert Bitcoin der Welt im Gegenzug für den verbrauchten Strom?
1. Gibt es eine praktikable Alternative zum Proof of Work (POW), um die notwendige Sicherheit für ein dezentrales Geld mit glaubwürdig festem Angebot zu gewährleisten?
1. Wie könnte das Bitcoin-Netzwerk potenzielle Vorteile für andere Branchen bieten, etwa durch die Nutzung erneuerbarer Energien, die Verringerung von Treibhausgasemissionen oder die Senkung der Energiekosten für bestimmte Anwendungen?
...
1. **Abbau**: Tonnen von Gestein werden abgebaut und auf große LKW verladen.
1. **Transport**: Diese LKW verbrauchen fossile Energie, schaffen meist nur wenige Meilen pro Gallone und benötigen Energie für ihre Herstellung.
1. **Mahlen**: Sobald die Tonnen Erz vor Ort sind, müssen sie zerkleinert und weiter gemahlen werden, um das Gold freizusetzen.
1. **Schmelzen**: Das Schmelzen erfordert das Erhitzen des Goldes auf hohe Temperaturen, um Verunreinigungen zu entfernen und das Gold weiter zu reinigen.
1. **Gießen**: Das Gold wird geschmolzen und durch das Eingießen in Formen zu Barren gegossen.
1. **Transport**: Die Goldbarren werden anschließend unter strengen Sicherheitsvorkehrungen transportiert.
1. **Lagerung**: Die Goldbarren werden dann in Banktresoren gelagert.
...
![Estimated Annual Energy Consumption (TWh/yr)](https://cdn.sanity.io/images/vje9ehw2/staging/47af59fa7d515383ea199a4c3cd5018e480eb32b-392x166.svg)

_Geschätzter jährlicher Energieverbrauch (TWh/Jahr). Quelle: Galaxy Digital._
...
![Industrial and residential uses of electricity, a comparison.](https://cdn.sanity.io/images/vje9ehw2/staging/ebfdc2a1e39b9276dab36b66caf0624989f9f110-529x263.svg)

_Industrielle und private Nutzung von Elektrizität, ein Vergleich. (Quelle: Universität Cambridge)_
...
1. [60+ Bitcoin Energie- und Mining-Statistiken](https://www.techopedia.com/bitcoin-mining-and-energy-statistics)
1. [Bitcoins Rolle im ESG-Imperativ KPMG](https://kpmg.com/kpmg-us/content/dam/kpmg/pdf/2023/bitcoins-role-esg-imperative.pdf)
1. [Wie Bitcoin die Energie der Ozeane für 1 Milliarde Menschen erschließen kann](https://bitcoinmagazine.com/business/bitcoin-unlocks-ocean-energy)
1. [Bitcoin trifft ESG: Die aufkommende Rolle von Bitcoin im nachhaltigen Investieren](https://alphapoint.com/blog/bitcoin-esg/)
1. [UK Offshore-Wind 2023 Rückblick und Ausblick 2024](https://ore.catapult.org.uk/blog/uk-offshore-wind-2023-round-up-and-2024-outlook/)
1. [Was Bloomberg beim CO2-Fußabdruck von Bitcoin falsch versteht](https://www.coindesk.com/markets/2021/02/08/what-bloomberg-gets-wrong-about-bitcoins-climate-footprint/)
