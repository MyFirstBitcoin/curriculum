...
![Bank of America Segment Breakdown](https://cdn.sanity.io/images/vje9ehw2/staging/afd00cad9d0f007b19b721fc46b0cd1e799e69ec-418x174.svg)

_Bank of America Segment Dağılımı (Kaynak: Bank of America 10-K)_
...
1. Ödeme isteği ödeme işlemcisine gönderilir
1. Ödeme işlemcisi isteği kart kuruluşuna (Visa, Mastercard) iletir
1. Kart kuruluşu isteği müşterinin kartı veren bankasına iletir
1. Kartı veren banka ödemeyi onaylar veya reddeder
1. Kart kuruluşu yanıtı ödeme işlemcisine iletir
1. Ödeme işlemcisi yanıtı satıcı terminaline iletir ve ödeme onaylanır veya reddedilir
...
1. Müşteri, kendi bankasına kartı veren bankaya (net) ödeme yapmasını talimat verir
...
1. Müşteri, Lightning cüzdanından akıllı telefonuyla fatura QR kodunu tarar ve fon gönderir
1. İşlem, Lightning Network’teki düğümlerin bitcoin’i bir likidite zinciri üzerinden iletmesiyle gerçek zamanlı olarak kesinleşir
