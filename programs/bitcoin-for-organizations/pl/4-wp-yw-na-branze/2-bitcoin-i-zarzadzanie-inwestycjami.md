...
![Global Wealth is Stored in Physical and Financial Assets](https://cdn.sanity.io/images/vje9ehw2/staging/c73b43e2f0dbbf8f38c60c1a1963adfb8f0d4b26-520x255.svg)

_Globalne bogactwo jest przechowywane w aktywach fizycznych i finansowych (Źródła: onceinaspecies.com; hope.com)_
...
_Wspaniała Siódemka: 1-roczna zmienność (Źródło: Fidelity Investments i Bloomberg Finance)_
...
![Rolling 3-Year Correlations of Bitcoin, Stocks, and Bonds (Aug. 1, 2010 - March 31, 2024)](https://cdn.sanity.io/images/vje9ehw2/staging/5c8c4e05d7d4b49f69d6dd2f36b53f05dcbb5c5b-522x235.svg)

_Kroczące 3-letnie korelacje Bitcoina, akcji i obligacji (Źródło: Fidelity Digital Assets; Bloomberg)_
...
1. [Boom czy krach, Bitcoin – ramy wyceny](https://www.researchgate.net/publication/321831572_Bitcoin_Valuation_Framework_Pub), Brian Leemoon, Uniwersytet Wilkesa, grudzień 2017.
1. [Byczy scenariusz dla Bitcoina](https://vijayboyapati.medium.com/the-bullish-case-for-bitcoin-6ecc8bdecc1), 2 marca 2018, autor: Vijay Boyapati, zawiera porównanie właściwości pieniężnych Bitcoina, złota i walut fiducjarnych.
1. [Potencjalna pełna wycena Bitcoina](https://www.onceinaspecies.com/p/bitcoins-full-potential-valuation), Jesse Myers, luty 2003.
1. Istnieje wiele źródeł dostarczających dane i wykresy dotyczące sieci Bitcoin. Przykładem jest Bitbo:[https://charts.bitbo.io/index/](https://charts.bitbo.io/index/)
1. Największe aktywa świata według kapitalizacji rynkowej są śledzone tutaj:[https://companiesmarketcap.com/assets-by-market-cap/](https://companiesmarketcap.com/assets-by-market-cap/)
1. [Portfel Nakamoto](https://nakamotoportfolio.com/nakamoto/start) to lista narzędzi, badań i otwartego oprogramowania, które mogą pomóc analitykom ocenić wpływ bitcoina na portfele.
1. [Rozważania dotyczące włączania bitcoina do portfeli inwestycyjnych](https://institutional.fidelity.com/app/literature/white-paper/9911508/considerations-for-including-bitcoin-in-investment-portfolios.html), Fidelity Institutional
1. Korelacja pokazuje siłę powiązań zwrotów między inwestycjami. Idealna liniowa zależność to korelacja równa 1, natomiast idealna zależność odwrotna to korelacja -1. Korelacja 0 oznacza brak związku między inwestycjami. Korelacja jest kluczowym elementem alokacji aktywów i może być użytecznym sposobem mierzenia dywersyfikacji portfela.
1. [Bliższe spojrzenie na zmienność Bitcoina](https://www.fidelitydigitalassets.com/research-and-insights/closer-look-bitcoins-volatility), Fidelity Digital Assets
1. Stopa inflacji w Stanach Zjednoczonych z TradingEconomics.com; źródło: U.S. Bureau of Labor Statistics[https://tradingeconomics.com/united-states/inflation-cpi](https://tradingeconomics.com/united-states/inflation-cpi)
1. [ETF-y na Bitcoina tworzą historię: Wall Street wkracza, ale dla bystrych inwestorów wciąż są szanse](https://finance.yahoo.com/news/bitcoin-etfs-making-history-wall-132117187.html), Yahoo Finance, 28 sierpnia 2024.
