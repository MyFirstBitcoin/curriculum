...
1. Najdłuższy łańcuch jest akceptowany przez węzły Bitcoina jako najbardziej prawidłowa wersja księgi i jest definiowany jako łańcuch, którego budowa wymagała najwięcej wysiłku (czyli największego dowodu pracy). Więcej informacji tutaj: [https://learnmeabitcoin.com/technical/blockchain/longest-chain/](https://learnmeabitcoin.com/technical/blockchain/longest-chain/)
