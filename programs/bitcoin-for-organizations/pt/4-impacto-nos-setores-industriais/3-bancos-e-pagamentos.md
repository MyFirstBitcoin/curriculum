...
![Bank of America Segment Breakdown](https://cdn.sanity.io/images/vje9ehw2/staging/06703c2633159e380199dc11b1af286a61f24782-418x174.svg)

_Divisão de Segmentos do Bank of America (Fonte: Bank of America 10-K)_
...
1. Solicitação de pagamento enviada ao processador de pagamentos
1. O processador de pagamentos encaminha a solicitação para a bandeira do cartão (Visa, Mastercard)
1. A bandeira do cartão encaminha a solicitação para o banco emissor do cartão do cliente
1. O banco emissor aprova ou recusa o pagamento
1. A bandeira do cartão repassa a resposta ao processador de pagamentos
1. O processador de pagamentos envia a resposta ao terminal do comerciante, que aprova ou recusa o pagamento
...
1. O cliente instrui seu banco a fazer o pagamento (líquido) ao banco emissor do cartão
...
1. O cliente escaneia o código QR da fatura a partir de sua carteira Lightning no smartphone e envia os fundos
1. A transação é finalizada em tempo real por nós da Lightning Network, passando bitcoin por uma cadeia de liquidez
