...
![Bank of America Segment Breakdown](https://cdn.sanity.io/images/vje9ehw2/staging/6d0c9e60359e8d00ec2be7becd0b0079465bd503-418x174.svg)

_Ripartizione dei Segmenti di Bank of America (Fonte: Bank of America 10-K)_
...
1. La richiesta di pagamento viene inviata al processore di pagamento
1. Il processore di pagamento invia la richiesta all'associazione delle carte (Visa, Mastercard)
1. L'associazione delle carte invia la richiesta alla banca emittente della carta del cliente
1. La banca emittente approva o rifiuta il pagamento
1. L'associazione delle carte trasmette la risposta al processore di pagamento
1. Il processore di pagamento invia la risposta al terminale del commerciante che approva o rifiuta il pagamento
...
1. Il cliente istruisce la propria banca a effettuare il pagamento (netto) alla banca emittente della carta
...
1. Il cliente scansiona il codice QR della fattura dal proprio wallet Lightning sullo smartphone e invia i fondi
1. La transazione viene finalizzata in tempo reale dai nodi della Lightning Network che fanno passare bitcoin attraverso una catena di liquidità
