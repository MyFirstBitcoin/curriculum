...
We define an **_asset_** as anything which has a market price or whose value is measured somewhere, for example on a company's balance sheet.

We define an asset as having **_economic value_** if the asset has a price, or whose value is measured somewhere, for example on a company's balance sheet.
