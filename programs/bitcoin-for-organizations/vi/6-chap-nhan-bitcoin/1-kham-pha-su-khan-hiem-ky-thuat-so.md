...
1. Chuỗi dài nhất được các node Bitcoin chấp nhận là phiên bản hợp lệ nhất của sổ cái vì được định nghĩa là chuỗi đã tiêu tốn nhiều công sức nhất (hoặc có bằng chứng công việc lớn nhất) để xây dựng. Thông tin thêm tại đây:[https://learnmeabitcoin.com/technical/blockchain/longest-chain/](https://learnmeabitcoin.com/technical/blockchain/longest-chain/)
