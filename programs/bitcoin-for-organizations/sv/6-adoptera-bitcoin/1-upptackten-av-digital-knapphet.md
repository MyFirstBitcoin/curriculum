...
1. Den längsta kedjan accepteras av Bitcoin-noder som den mest giltiga versionen av huvudboken och definieras som den kedja som krävde mest arbete (eller störst proof-of-work) att bygga. Mer information här: [https://learnmeabitcoin.com/technical/blockchain/longest-chain/](https://learnmeabitcoin.com/technical/blockchain/longest-chain/)
