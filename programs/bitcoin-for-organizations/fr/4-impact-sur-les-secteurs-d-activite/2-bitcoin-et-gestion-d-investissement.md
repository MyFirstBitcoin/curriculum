...
Les gestionnaires d'investissement professionnels disposent déjà d'un processus rigoureux établi pour évaluer les investissements potentiels. En 2017, l'analyste de systèmes d'affaires Brian Leemoon[a développé un cadre](https://www.researchgate.net/publication/321831572_Bitcoin_Valuation_Framework_Pub) pour évaluer la technologie Bitcoin en utilisant trois méthodes d'analyse d'entreprise bien établies : SWOT, PESTLE et les cinq forces de Porter. Du point de vue d'un gestionnaire d'investissement, un exemple résumé d'analyse SWOT pour le Bitcoin pourrait ressembler à ceci :
...
![Global Wealth is Stored in Physical and Financial Assets](https://cdn.sanity.io/images/vje9ehw2/staging/0e5de987f2d56cd9252ed1a213ba838cdcf0b32f-520x255.svg)

_La richesse mondiale est stockée dans des actifs physiques et financiers (Sources : onceinaspecies.com ; hope.com)_
...
_Magnificent Seven : volatilité sur 1 an (Source : Fidelity Investments et Bloomberg Finance)_
...
![Rolling 3-Year Correlations of Bitcoin, Stocks, and Bonds (Aug. 1, 2010 - March 31, 2024)](https://cdn.sanity.io/images/vje9ehw2/staging/310ed0544f310bd03a4dc303013e2680623f5564-522x235.svg)

_Corrélations glissantes sur 3 ans du Bitcoin, des actions et des obligations (Source : Fidelity Digital Assets ; Bloomberg)_
...
1. [Boom ou krach, un cadre d’évaluation du Bitcoin](https://www.researchgate.net/publication/321831572_Bitcoin_Valuation_Framework_Pub), Brian Leemoon, Université Wilkes, décembre 2017.
1. [Le cas haussier pour le Bitcoin](https://vijayboyapati.medium.com/the-bullish-case-for-bitcoin-6ecc8bdecc1), 2 mars 2018 par Vijay Boyapati, contient une comparaison des propriétés monétaires du Bitcoin, de l’or et de la monnaie fiduciaire.
1. [La valorisation potentielle complète du Bitcoin](https://www.onceinaspecies.com/p/bitcoins-full-potential-valuation), Jesse Myers, février 2003.
1. De nombreuses ressources fournissent des données et graphiques sur le réseau Bitcoin. Bitbo en est un exemple : [https://charts.bitbo.io/index/](https://charts.bitbo.io/index/)
1. Les principaux actifs mondiaux par capitalisation boursière sont suivis ici : [https://companiesmarketcap.com/assets-by-market-cap/](https://companiesmarketcap.com/assets-by-market-cap/)
1. [Le portefeuille Nakamoto](https://nakamotoportfolio.com/nakamoto/start) est une liste d’outils, de recherches et de codes open-source qui peuvent aider les analystes à évaluer l’impact du bitcoin sur les portefeuilles.
1. [Considérations pour inclure le bitcoin dans les portefeuilles d’investissement](https://institutional.fidelity.com/app/literature/white-paper/9911508/considerations-for-including-bitcoin-in-investment-portfolios.html), Fidelity Institutional
1. La corrélation révèle la force des relations de rendement entre les investissements. Une relation linéaire parfaite est représentée par une corrélation de 1, tandis qu’une relation parfaitement négative a une corrélation de -1. Une corrélation de 0 indique l’absence de relation entre les investissements. La corrélation est un élément essentiel de l’allocation d’actifs et peut être un moyen utile de mesurer la diversité d’un portefeuille.
1. [Un regard approfondi sur la volatilité du Bitcoin](https://www.fidelitydigitalassets.com/research-and-insights/closer-look-bitcoins-volatility), Fidelity Digital Assets
1. Taux d'inflation des États-Unis provenant de TradingEconomics.com ; source : Bureau of Labor Statistics des États-Unis[https://tradingeconomics.com/united-states/inflation-cpi](https://tradingeconomics.com/united-states/inflation-cpi)
1. [Les ETF Bitcoin font l'histoire : Wall Street se précipite, mais des opportunités subsistent pour les investisseurs avisés](https://finance.yahoo.com/news/bitcoin-etfs-making-history-wall-132117187.html), Yahoo Finance, 28 août 2024.
